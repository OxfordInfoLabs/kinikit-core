...
class XMLToObjectConverterTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testIfClassPassedToConverterHasNoBlankConstructorThrowException() {
        self::assertTrue(true);
        $badClassXML = '<TestBadConstructorObject phpNameSpace="Kinikit\Core\Serialisation\XML"></TestBadConstructorObject>';
        $element = $this->getDocumentElementFromXMLString($badClassXML);
    ...
    public function testIfNodeForNonSerialisableSimpleObjectPassedClassNotSerialisableExceptionIsRaised() {
        self::assertTrue(true);
        $testObject1XML = '<TestObject0 phpNameSpace="Kinikit\Core\Serialisation\XML"><school>Arbury Primary School</school><teacher>Mr Hessey</teacher></TestObject0>';
    ...
    public function testIfNodeForStandardObjectWithPublicAccessorsPassedToConverterItIsMapped() {
        ...
        $testObject1XML = '<TestObject1 phpNameSpace="Kinikit\Core\Serialisation\XML"><Name>Mr Man</Name><Phone>01865 787879</Phone><Age>34</Age><Notes><Array><Value>pierre</Value><Value>shopping</Value></Array></Notes></TestObject1>';
        $element = $this->getDocumentElementFromXMLString($testObject1XML);
    ...
    public function testNodeForProtectedObjectsGetMappedOnSubmissionToConverter() {
        $testObject2XML = '<TestObject2 phpNameSpace="Kinikit\Core\Serialisation\XML"><Street>Oxford Road</Street><City>London</City><County>Middlesex</County></TestObject2>';
        $element = $this->getDocumentElementFromXMLString($testObject2XML);
        $expectedValue = new TestObject2 ("Oxford Road", "London", "Middlesex");

        $this->assertEquals($expectedValue, $this->converter->convertDOM($element));

        $testObject3XML = '<TestObject3 phpNameSpace="Kinikit\Core\Serialisation\XML"><profession>Accountancy</profession><title>Auditor</title><salary>56000</salary></TestObject3>';
    ...
    public function testComplexNodeGetsMappedOnSubmissionToConverter() {
        ...
        $complexXML = '<TestComplexObject phpNameSpace="Kinikit\Core\Serialisation\XML"><details>' . $this->objectToXMLConverter->convert($details) . "</details>" . "<addresses><Array>" . $this->objectToXMLConverter->convert($address1) . $this->objectToXMLConverter->convert($address2) . "</Array></addresses>" . "<jobDetails>" . $this->objectToXMLConverter->convert($jobDetails) . "</jobDetails></TestComplexObject>";
    ...
    public function testAttributesMayBeUsedInsteadAndTheseGetMappedToPropertiesOnClassesAsWell() {
        ...
        $testObject1XML = '<TestObject1 phpNameSpace="Kinikit\Core\Serialisation\XML" age="33" phone="01865 778787" name="Mark"  />';
    ...
    public function testIfArrayTagOmittedForArrayWithSingleValueEntryThisIsMappedToSingleValue() {
        ...
        $testObject1XML = '<TestObject1 phpNameSpace="Kinikit\Core\Serialisation\XML"><name>Mr Man</name><phone>01865 787879</phone><age>34</age><notes><Value>pierre</Value></notes></TestObject1>';
        $element = $this->getDocumentElementFromXMLString($testObject1XML);
    ...
    public function testIfArrayTagOmittedForArrayWithMultipleEntriesThisIsMappedCorrectly() {
        ...
        $testObject1XML = '<TestObject1 phpNameSpace="Kinikit\Core\Serialisation\XML"><name>Mr Man</name><phone>01865 787879</phone><age>34</age><notes><Value>pierre</Value><Value>marko</Value><Value>Pierre</Value></notes></TestObject1>';
        $element = $this->getDocumentElementFromXMLString($testObject1XML);
    ...
    public function testIfKeyAttributeUsedForObjectsInArraysTheseAreMappedToAnAssociativeArrayAlso() {
        ...
        $testXML = '<Array><TestObject2 phpNameSpace="Kinikit\Core\Serialisation\XML" key="oxford"><Street>Oxford Road</Street><City>London</City><County>Middlesex</County></TestObject2><TestObject2 phpNameSpace="Kinikit\Core\Serialisation\XML" key="cambridge"><Street>Cambridge Road</Street><City>Cambridge</City><County>Cambs</County></TestObject2></Array>';
    ...
    public function testIfTextElementExistsAsAttributeInObjectThisIsMappedToTheTextMemberOfClass() {
        ...
        $testXML = '<TestObject4 phpNameSpace="Kinikit\Core\Serialisation\XML" street="Oxford Road" city="London" county="Middlesex">Something special</TestObject4>';
    ...
    public function testCanSupplyAnOptionalMapOfTagNamesToConvertMethodsWhichMapXmlTagsToClassNames() {
        ...
        $converter = new XMLToObjectConverter (array("MyTag" => "Kinikit\Core\Serialisation\XML\TestObject4"));
    ...
    public function testCanCorrectlyMapNestedArraysOfValues() {
        ...
        $testXML = '<TestObject1 phpNameSpace="Kinikit\Core\Serialisation\XML" >
		<name>
			<Array>
				<Value>
					<Array>
