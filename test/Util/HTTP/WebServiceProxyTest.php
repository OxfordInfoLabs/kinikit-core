...
class WebServiceProxyTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testCanCreateSimpleNoParamsWebServiceProxyAndRetrieveResults() {
        ...
        $posts = $proxy->callMethod("posts", "GET", array(), null, "Kinikit\Core\Util\HTTP\Post[]");
    ...
    public function testCanPassParametersThrough() {
        ...
        $proxy = new WebServiceProxy("http://jsonplaceholder.typicode.com");
        $comments = $proxy->callMethod("comments", "GET", array("postId" => 1), null, "Kinikit\Core\Util\HTTP\Comment[]");
        ...
        $proxy = new WebServiceProxy("http://jsonplaceholder.typicode.com");
        $post = $proxy->callMethod("posts", "POST", null, $newPost, "Kinikit\Core\Util\HTTP\Post");
    ...
    public function testGlobalParametersAreMergedIn() {
        ...
        $comments = $proxy->callMethod("comments", "GET", array(), null, "Kinikit\Core\Util\HTTP\Comment[]");
