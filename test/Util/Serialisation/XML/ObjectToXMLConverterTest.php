...
class ObjectToXMLConverterTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testStandardObjectWithPrivateMembersAndPublicGettersAndSettersGetsMappedAsExpected() {
        ...
        $expectedOutput = '<TestObject1 phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><name><![CDATA[Marko]]></name><phone><![CDATA[01865 989889]]></phone><age><![CDATA[13]]></age><notes><Array><Value><![CDATA[run it by me]]></Value><Value><![CDATA[shop around]]></Value><Value><![CDATA[go fishing]]></Value></Array></notes></TestObject1>';
        ...
        $expectedOutput = '<TestObject1 phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><name><![CDATA[Pierre]]></name><phone><![CDATA[718288]]></phone><age><![CDATA[39]]></age><notes><Array><Value><![CDATA[Go now]]></Value></Array></notes></TestObject1>';
        $this->assertEquals($expectedOutput, $this->converter->convert($testObject1));
    ...
    public function testProtectedMemberObjectGetsMappedCorrectly() {
        ...
        $expectedOutput = '<TestObject2 phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><street><![CDATA[3 Hawlings Row]]></street><city><![CDATA[Oxford]]></city><county><![CDATA[Oxon]]></county></TestObject2>';
    ...
    public function testPrivateFieldProtectedAccessorObjectGetsMappedCorrectly() {
        ...
        $expectedOutput = '<TestObject3 phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><profession><![CDATA[Medicine]]></profession><title><![CDATA[Doctor]]></title><salary><![CDATA[37750]]></salary></TestObject3>';
    ...
    public function testComplexObjectGetsMappedCorrectly() {
        ...
        $expectedOutput = '<TestComplexObject phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><details>' . $this->converter->convert($details) . "</details>" . "<addresses><Array><Value>" . $this->converter->convert($address1) . "</Value><Value>" . $this->converter->convert($address2) . "</Value></Array></addresses>" . "<jobDetails>" . $this->converter->convert($job) . "</jobDetails>" . "</TestComplexObject>";
    ...
    public function testObjectsWithMagicTextElementGetWrittenOutWithAllOtherMembersAsAttributes() {
        ...
        $expectedOutput = '<TestObject4 phpNameSpace="Kinikit\Core\Util\Serialisation\XML" street="The Lane" city="Hove" county="East Sussex">Some other random text</TestObject4>';
    ...
    public function testAssociativeArrayObjectsAlwaysHaveAKeyAttributeRatherThanNestedKeyElement() {
        ...
        $expectedOutput = '<TestObject2 phpNameSpace="Kinikit\Core\Util\Serialisation\XML" key="sussex"><street><![CDATA[The Lane]]></street><city><![CDATA[Hove]]></city><county><![CDATA[East Sussex]]></county></TestObject2>';
        ...
        $expectedOutput = '<Array><Value><TestObject2 phpNameSpace="Kinikit\Core\Util\Serialisation\XML" key="sussex"><street><![CDATA[The Lane]]></street><city><![CDATA[Hove]]></city><county><![CDATA[East Sussex]]></county></TestObject2></Value>' . '<Value><TestObject2 phpNameSpace="Kinikit\Core\Util\Serialisation\XML" key="brighton"><street><![CDATA[My lane]]></street><city><![CDATA[Brighton]]></city><county><![CDATA[ES]]></county></TestObject2></Value></Array>';
    ...
    public function testBlankTextEntriesAreHandledCorrectly() {
        ...
        $this->assertEquals('<TestObjectWithText phpNameSpace="Kinikit\Core\Util\Serialisation\XML" otherMember="">Marko</TestObjectWithText>', $this->converter->convert($testWithText));

        $testBlankContent = new TestObjectWithText ("");
        $this->assertEquals('<TestObjectWithText phpNameSpace="Kinikit\Core\Util\Serialisation\XML" otherMember=""></TestObjectWithText>', $this->converter->convert($testBlankContent));

        $testArrayOfText = array(new TestObjectWithText ("Mark"), new TestObjectWithText (""));
        $this->assertEquals('<Array><Value><TestObjectWithText phpNameSpace="Kinikit\Core\Util\Serialisation\XML" otherMember="">Mark</TestObjectWithText></Value><Value><TestObjectWithText phpNameSpace="Kinikit\Core\Util\Serialisation\XML" otherMember=""></TestObjectWithText></Value></Array>', $this->converter->convert($testArrayOfText));
    ...
    public function testCanConstructWithTagMappingsAndTheseGetReplacedInOutput() {
        ...
        $expectedOutput = '<TestComplexObject phpNameSpace="Kinikit\Core\Util\Serialisation\XML">';
    ...
    public function testCanOmitContainerElementsForOutputWithArrays() {
        ...
        $expectedOutput .= '<TestObject3 phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><profession><![CDATA[Professor]]></profession><title><![CDATA[Sir]]></title><salary><![CDATA[22000]]></salary></TestObject3>';
        $expectedOutput .= '<TestObject3 phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><profession><![CDATA[Coder]]></profession><title><![CDATA[Mr]]></title><salary><![CDATA[35000]]></salary></TestObject3>';
    ...
    public function testOmitSingletonClassFlagRemovesClassTagsFromSingleObjectMembers() {
        ...
        $expectedOutput .= "<Kinikit\Core\Util\Serialisation\XML\TestObject1><name><![CDATA[Mark]]></name><phone><![CDATA[712]]></phone><age><![CDATA[12]]></age><notes><![CDATA[Bing]]></notes></Kinikit\Core\Util\Serialisation\XML\TestObject1>";
        $expectedOutput .= "<Kinikit\Core\Util\Serialisation\XML\TestObject1><name><![CDATA[Philip]]></name><phone><![CDATA[713]]></phone><age><![CDATA[15]]></age><notes><![CDATA[Bong]]></notes></Kinikit\Core\Util\Serialisation\XML\TestObject1>";
        $expectedOutput .= "</jobDetails>";
    ...
    public function testCanIgnoreBlankMembersIfRequired() {
        ...
        $expectedOutput = '<TestComplexObject phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><details><TestObject3 phpNameSpace="Kinikit\Core\Util\Serialisation\XML">';
        $expectedOutput .= "<profession><![CDATA[Professor]]></profession><salary><![CDATA[22000]]></salary>";
        $expectedOutput .= "</TestObject3></details>";
        $expectedOutput .= "<addresses>";
        $expectedOutput .= '<TestObject2 phpNameSpace="Kinikit\Core\Util\Serialisation\XML"><street><![CDATA[Magdalen Centre]]></street><city><![CDATA[Oxford]]></city>';
